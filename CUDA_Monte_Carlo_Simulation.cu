...
main( int argc, char *argv[ ] )
{
	...
	// execute the kernel:
	MonteCarlo<<< grid, threads >>>(IN dholeaxs, IN dholeays, IN dholears, IN dholebxs, IN dholebys, IN dholebrs, IN dholecxs, IN dholecys, IN dholecrs, OUT dsuccesses);
	...
	cudaMemcpy(dsuccesses, hsuccesses, NUMTRIALS *sizeof(int), cudaMemcpyDeviceToHost );
	CudaCheckError( );
